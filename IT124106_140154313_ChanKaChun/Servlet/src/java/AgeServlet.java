import Web_Service.ArrayOfAgeGrp;
import Web_Service.AgeGrp;
...
public class AgeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ArrayOfAgeGrp agegroup = getAllByAge();
        ArrayList<AgeGrp> agelist = new ArrayList<AgeGrp>();
        agelist = (ArrayList<AgeGrp>) agegroup.getAgeGrp();
         response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
...
"                                <li class=\"active\"><a href=\"AgeServlet\">By Age</a></li>\n" +
"                                <li role=\"separator\" class=\"divider\"></li>\n" +
...
"        </nav>");
             ...
             out.println("<thead><tr><th>Age Group</th><th>Male Population</th><th>Female Population</th><th>Total Population</th></tr></thead><tbody>");
            for(AgeGrp temp : agelist){
                out.print("<tr>");
